  ...
  if(isset($_SESSION["vendor_email"]) and $gtu=='guest')
  {
	   echo "<div class='container text-center ft-black'>";
			echo "<div class='content-center brand'>";
			  echo "<h2>Cricket Youtube Videos</h2>";
			  echo "<h4><a style='a:link{ color:black; }' href='https://www.youtube.com/user/CricketICC'>ICC</a></h4>";
			  echo "<h4><a href='https://www.youtube.com/user/ecbcricket'>England and Wales Cricket Board</a></h4>";
			  echo "<h4><a href='https://www.youtube.com/user/ecbcricket'>cricket.com.au</a></h4>";  
			echo "</div>";
	   echo "</div>";
  }
    ?>
